    ...
    <section className="hero_section">
      ...
      <div className="hero_wrapper">
        ...
        <div className="hero_text">
          <p>
            At the center of our solar system is the Sun, a powerful star that
            gives light and energy to everything around it.{" "}
          </p>
          <svg
            ref={mouseRef}
            width="36"
